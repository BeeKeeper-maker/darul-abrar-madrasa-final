...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['auth', 'role:guardian'])->group(function () {
        ...
        // View children's attendances
        Route::get('/guardian/attendances', [GuardianController::class, 'childrenAttendances'])->name('guardian.attendances');
        
        // View children's results
        Route::get('/guardian/results', [GuardianController::class, 'childrenResults'])->name('guardian.results');
        
        // View children's fees
        Route::get('/guardian/fees', [GuardianController::class, 'childrenFees'])->name('guardian.fees');
    });
