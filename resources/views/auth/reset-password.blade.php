            ...
            <div class="bg-white shadow-md rounded-lg px-8 py-6">
                ...
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <input id="password_confirmation" type="password" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="password_confirmation" required autocomplete="new-password">
                    </div>
